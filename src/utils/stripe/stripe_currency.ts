export const currency_list: { currency: string; code: string }[] = [
...
export const currency_list_code = currency_list.map(
  (currency: { code: string; currency: string }) => currency.code,
);
